...
public class SmsProvider extends ContentProvider{
	...
	public Cursor query(Uri uri, String[] projection, String selection,
		...
		switch (mUriMatcher.match(uri)) {
		case SMS:
			c = mHelper.getReadableDatabase().query(SmsOpenHelper.T_SMS,projection,selection,selectionArgs, null, null, sortOrder);
			System.out.println("--------SmsProvider-----querySuccess----------------");
			break;
		case SESSION:
			c = mHelper.getReadableDatabase().rawQuery("SELECT * FROM "
